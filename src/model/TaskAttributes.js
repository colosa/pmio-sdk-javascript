...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProcessMakerApi.TaskAttributes = factory(root.ProcessMakerApi.ApiClient, root.ProcessMakerApi.DateTime);
  }
   ...
   * @module model/TaskAttributes
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TaskAttributes</code>.
   * @alias module:model/TaskAttributes
   * @class
   * @param name {String} 
   * @param processId {String} 
   * @param type {module:model/TaskAttributes.TypeEnum} 
   * @param assignType {module:model/TaskAttributes.AssignTypeEnum} 
   ...
   * @param {module:model/TaskAttributes} obj Optional instance to populate.
   * @return {module:model/TaskAttributes} The populated <code>TaskAttributes</code> instance.
   */
  ...
  /**
   * @member {module:model/TaskAttributes.TypeEnum} type
   * @default 'NORMAL'
   */
  exports.prototype['type'] = 'NORMAL';
  /**
   * @member {module:model/TaskAttributes.AssignTypeEnum} assign_type
   * @default 'CYCLIC'
   */
