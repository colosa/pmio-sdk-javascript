...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProcessMakerApi.InputOutputAttributes = factory(root.ProcessMakerApi.ApiClient, root.ProcessMakerApi.DateTime);
  }
   ...
   * @module model/InputOutputAttributes
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>InputOutputAttributes</code>.
   * @alias module:model/InputOutputAttributes
   * @class
   ...
   * @param {module:model/InputOutputAttributes} obj Optional instance to populate.
   * @return {module:model/InputOutputAttributes} The populated <code>InputOutputAttributes</code> instance.
   */
