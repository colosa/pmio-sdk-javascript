...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProcessMakerApi.TaskConnectorAttributes = factory(root.ProcessMakerApi.ApiClient, root.ProcessMakerApi.DateTime);
  }
   ...
   * @module model/TaskConnectorAttributes
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TaskConnectorAttributes</code>.
   * @alias module:model/TaskConnectorAttributes
   * @class
   */
   ...
   * @param {module:model/TaskConnectorAttributes} obj Optional instance to populate.
   * @return {module:model/TaskConnectorAttributes} The populated <code>TaskConnectorAttributes</code> instance.
   */
