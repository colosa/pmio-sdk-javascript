...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProcessMakerApi.ProcessAttributes = factory(root.ProcessMakerApi.ApiClient, root.ProcessMakerApi.DateTime);
  }
   ...
   * @module model/ProcessAttributes
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ProcessAttributes</code>.
   * @alias module:model/ProcessAttributes
   * @class
   * @param name {String} 
   * @param status {module:model/ProcessAttributes.StatusEnum} 
   * @param durationBy {module:model/ProcessAttributes.DurationByEnum} 
   * @param type {module:model/ProcessAttributes.TypeEnum} 
   * @param designAccess {module:model/ProcessAttributes.DesignAccessEnum} 
   */
   ...
   * @param {module:model/ProcessAttributes} obj Optional instance to populate.
   * @return {module:model/ProcessAttributes} The populated <code>ProcessAttributes</code> instance.
   */
  ...
  /**
   * @member {module:model/ProcessAttributes.StatusEnum} status
   * @default 'ACTIVE'
   */
  exports.prototype['status'] = 'ACTIVE';
  /**
   * @member {module:model/ProcessAttributes.DurationByEnum} duration_by
   * @default 'WORKING_DAYS'
   */
  exports.prototype['duration_by'] = 'WORKING_DAYS';
  /**
   * @member {module:model/ProcessAttributes.TypeEnum} type
   * @default 'NORMAL'
   */
  ...
  /**
   * @member {module:model/ProcessAttributes.DesignAccessEnum} design_access
   * @default 'PUBLIC'
   */
