...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.ClientItem();
  });
  ...
  describe('ClientItem', function() {
    it('should create an instance of ClientItem', function() {
      // uncomment below and update the code to test ClientItem
      //var instane = new ProcessMakerApi.ClientItem();
      //expect(instance).to.be.a(ProcessMakerApi.ClientItem);
    });
