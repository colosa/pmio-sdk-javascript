...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.ProcessItem();
  });
  ...
  describe('ProcessItem', function() {
    it('should create an instance of ProcessItem', function() {
      // uncomment below and update the code to test ProcessItem
      //var instane = new ProcessMakerApi.ProcessItem();
      //expect(instance).to.be.a(ProcessMakerApi.ProcessItem);
    });
