...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.TaskInstanceUpdateItem();
  });
  ...
  describe('TaskInstanceUpdateItem', function() {
    it('should create an instance of TaskInstanceUpdateItem', function() {
      // uncomment below and update the code to test TaskInstanceUpdateItem
      //var instane = new ProcessMakerApi.TaskInstanceUpdateItem();
      //expect(instance).to.be.a(ProcessMakerApi.TaskInstanceUpdateItem);
    });
