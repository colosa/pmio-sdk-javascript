...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.GatewayItem();
  });
  ...
  describe('GatewayItem', function() {
    it('should create an instance of GatewayItem', function() {
      // uncomment below and update the code to test GatewayItem
      //var instane = new ProcessMakerApi.GatewayItem();
      //expect(instance).to.be.a(ProcessMakerApi.GatewayItem);
    });
