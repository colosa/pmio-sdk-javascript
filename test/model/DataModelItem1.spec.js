...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.DataModelItem1();
  });
  ...
  describe('DataModelItem1', function() {
    it('should create an instance of DataModelItem1', function() {
      // uncomment below and update the code to test DataModelItem1
      //var instane = new ProcessMakerApi.DataModelItem1();
      //expect(instance).to.be.a(ProcessMakerApi.DataModelItem1);
    });
