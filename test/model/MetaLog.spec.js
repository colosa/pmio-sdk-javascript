...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.MetaLog();
  });
  ...
  describe('MetaLog', function() {
    it('should create an instance of MetaLog', function() {
      // uncomment below and update the code to test MetaLog
      //var instane = new ProcessMakerApi.MetaLog();
      //expect(instance).to.be.a(ProcessMakerApi.MetaLog);
    });

    it('should have the property importLog (base name: "import_log")', function() {
      // uncomment below and update the code to test the property importLog
      //var instane = new ProcessMakerApi.MetaLog();
