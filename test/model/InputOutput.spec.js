...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InputOutput();
  });
  ...
  describe('InputOutput', function() {
    it('should create an instance of InputOutput', function() {
      // uncomment below and update the code to test InputOutput
      //var instane = new ProcessMakerApi.InputOutput();
      //expect(instance).to.be.a(ProcessMakerApi.InputOutput);
    });
