...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.DataModelItem();
  });
  ...
  describe('DataModelItem', function() {
    it('should create an instance of DataModelItem', function() {
      // uncomment below and update the code to test DataModelItem
      //var instane = new ProcessMakerApi.DataModelItem();
      //expect(instance).to.be.a(ProcessMakerApi.DataModelItem);
    });
