...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InstanceUpdateItem();
  });
  ...
  describe('InstanceUpdateItem', function() {
    it('should create an instance of InstanceUpdateItem', function() {
      // uncomment below and update the code to test InstanceUpdateItem
      //var instane = new ProcessMakerApi.InstanceUpdateItem();
      //expect(instance).to.be.a(ProcessMakerApi.InstanceUpdateItem);
    });
