...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.UserUpdateItem();
  });
  ...
  describe('UserUpdateItem', function() {
    it('should create an instance of UserUpdateItem', function() {
      // uncomment below and update the code to test UserUpdateItem
      //var instane = new ProcessMakerApi.UserUpdateItem();
      //expect(instance).to.be.a(ProcessMakerApi.UserUpdateItem);
    });
