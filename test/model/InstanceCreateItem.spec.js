...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InstanceCreateItem();
  });
  ...
  describe('InstanceCreateItem', function() {
    it('should create an instance of InstanceCreateItem', function() {
      // uncomment below and update the code to test InstanceCreateItem
      //var instane = new ProcessMakerApi.InstanceCreateItem();
      //expect(instance).to.be.a(ProcessMakerApi.InstanceCreateItem);
    });
