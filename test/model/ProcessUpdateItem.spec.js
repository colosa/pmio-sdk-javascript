...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.ProcessUpdateItem();
  });
  ...
  describe('ProcessUpdateItem', function() {
    it('should create an instance of ProcessUpdateItem', function() {
      // uncomment below and update the code to test ProcessUpdateItem
      //var instane = new ProcessMakerApi.ProcessUpdateItem();
      //expect(instance).to.be.a(ProcessMakerApi.ProcessUpdateItem);
    });
