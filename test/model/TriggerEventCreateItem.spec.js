...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.TriggerEventCreateItem();
  });
  ...
  describe('TriggerEventCreateItem', function() {
    it('should create an instance of TriggerEventCreateItem', function() {
      // uncomment below and update the code to test TriggerEventCreateItem
      //var instane = new ProcessMakerApi.TriggerEventCreateItem();
      //expect(instance).to.be.a(ProcessMakerApi.TriggerEventCreateItem);
    });
