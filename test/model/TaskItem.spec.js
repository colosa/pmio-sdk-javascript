...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.TaskItem();
  });
  ...
  describe('TaskItem', function() {
    it('should create an instance of TaskItem', function() {
      // uncomment below and update the code to test TaskItem
      //var instane = new ProcessMakerApi.TaskItem();
      //expect(instance).to.be.a(ProcessMakerApi.TaskItem);
    });
