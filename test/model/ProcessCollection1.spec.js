...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.ProcessCollection1();
  });
  ...
  describe('ProcessCollection1', function() {
    it('should create an instance of ProcessCollection1', function() {
      // uncomment below and update the code to test ProcessCollection1
      //var instane = new ProcessMakerApi.ProcessCollection1();
      //expect(instance).to.be.a(ProcessMakerApi.ProcessCollection1);
    });
