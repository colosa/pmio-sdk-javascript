...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.ProcessCollection();
  });
  ...
  describe('ProcessCollection', function() {
    it('should create an instance of ProcessCollection', function() {
      // uncomment below and update the code to test ProcessCollection
      //var instane = new ProcessMakerApi.ProcessCollection();
      //expect(instance).to.be.a(ProcessMakerApi.ProcessCollection);
    });
