...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.ProcessCreateItem();
  });
  ...
  describe('ProcessCreateItem', function() {
    it('should create an instance of ProcessCreateItem', function() {
      // uncomment below and update the code to test ProcessCreateItem
      //var instane = new ProcessMakerApi.ProcessCreateItem();
      //expect(instance).to.be.a(ProcessMakerApi.ProcessCreateItem);
    });
