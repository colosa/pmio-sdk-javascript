...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.GroupAddUsersItem();
  });
  ...
  describe('GroupAddUsersItem', function() {
    it('should create an instance of GroupAddUsersItem', function() {
      // uncomment below and update the code to test GroupAddUsersItem
      //var instane = new ProcessMakerApi.GroupAddUsersItem();
      //expect(instance).to.be.a(ProcessMakerApi.GroupAddUsersItem);
    });
