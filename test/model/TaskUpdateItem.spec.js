...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.TaskUpdateItem();
  });
  ...
  describe('TaskUpdateItem', function() {
    it('should create an instance of TaskUpdateItem', function() {
      // uncomment below and update the code to test TaskUpdateItem
      //var instane = new ProcessMakerApi.TaskUpdateItem();
      //expect(instance).to.be.a(ProcessMakerApi.TaskUpdateItem);
    });
