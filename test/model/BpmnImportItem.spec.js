...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.BpmnImportItem();
  });
  ...
  describe('BpmnImportItem', function() {
    it('should create an instance of BpmnImportItem', function() {
      // uncomment below and update the code to test BpmnImportItem
      //var instane = new ProcessMakerApi.BpmnImportItem();
      //expect(instance).to.be.a(ProcessMakerApi.BpmnImportItem);
    });
