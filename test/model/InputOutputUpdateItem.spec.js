...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InputOutputUpdateItem();
  });
  ...
  describe('InputOutputUpdateItem', function() {
    it('should create an instance of InputOutputUpdateItem', function() {
      // uncomment below and update the code to test InputOutputUpdateItem
      //var instane = new ProcessMakerApi.InputOutputUpdateItem();
      //expect(instance).to.be.a(ProcessMakerApi.InputOutputUpdateItem);
    });
