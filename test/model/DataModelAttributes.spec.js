...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.DataModelAttributes();
  });
  ...
  describe('DataModelAttributes', function() {
    it('should create an instance of DataModelAttributes', function() {
      // uncomment below and update the code to test DataModelAttributes
      //var instane = new ProcessMakerApi.DataModelAttributes();
      //expect(instance).to.be.a(ProcessMakerApi.DataModelAttributes);
    });
