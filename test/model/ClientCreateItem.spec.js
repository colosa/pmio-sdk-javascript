...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.ClientCreateItem();
  });
  ...
  describe('ClientCreateItem', function() {
    it('should create an instance of ClientCreateItem', function() {
      // uncomment below and update the code to test ClientCreateItem
      //var instane = new ProcessMakerApi.ClientCreateItem();
      //expect(instance).to.be.a(ProcessMakerApi.ClientCreateItem);
    });
