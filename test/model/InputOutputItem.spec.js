...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InputOutputItem();
  });
  ...
  describe('InputOutputItem', function() {
    it('should create an instance of InputOutputItem', function() {
      // uncomment below and update the code to test InputOutputItem
      //var instane = new ProcessMakerApi.InputOutputItem();
      //expect(instance).to.be.a(ProcessMakerApi.InputOutputItem);
    });
