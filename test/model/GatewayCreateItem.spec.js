...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.GatewayCreateItem();
  });
  ...
  describe('GatewayCreateItem', function() {
    it('should create an instance of GatewayCreateItem', function() {
      // uncomment below and update the code to test GatewayCreateItem
      //var instane = new ProcessMakerApi.GatewayCreateItem();
      //expect(instance).to.be.a(ProcessMakerApi.GatewayCreateItem);
    });
