...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.FlowCollection();
  });
  ...
  describe('FlowCollection', function() {
    it('should create an instance of FlowCollection', function() {
      // uncomment below and update the code to test FlowCollection
      //var instane = new ProcessMakerApi.FlowCollection();
      //expect(instance).to.be.a(ProcessMakerApi.FlowCollection);
    });
