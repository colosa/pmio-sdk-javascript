...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.TaskRemoveGroupsItem();
  });
  ...
  describe('TaskRemoveGroupsItem', function() {
    it('should create an instance of TaskRemoveGroupsItem', function() {
      // uncomment below and update the code to test TaskRemoveGroupsItem
      //var instane = new ProcessMakerApi.TaskRemoveGroupsItem();
      //expect(instance).to.be.a(ProcessMakerApi.TaskRemoveGroupsItem);
    });
