...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.ResultSuccess();
  });
  ...
  describe('ResultSuccess', function() {
    it('should create an instance of ResultSuccess', function() {
      // uncomment below and update the code to test ResultSuccess
      //var instane = new ProcessMakerApi.ResultSuccess();
      //expect(instance).to.be.a(ProcessMakerApi.ResultSuccess);
    });
