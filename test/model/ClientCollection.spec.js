...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.ClientCollection();
  });
  ...
  describe('ClientCollection', function() {
    it('should create an instance of ClientCollection', function() {
      // uncomment below and update the code to test ClientCollection
      //var instane = new ProcessMakerApi.ClientCollection();
      //expect(instance).to.be.a(ProcessMakerApi.ClientCollection);
    });
