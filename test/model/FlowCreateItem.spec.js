...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.FlowCreateItem();
  });
  ...
  describe('FlowCreateItem', function() {
    it('should create an instance of FlowCreateItem', function() {
      // uncomment below and update the code to test FlowCreateItem
      //var instane = new ProcessMakerApi.FlowCreateItem();
      //expect(instance).to.be.a(ProcessMakerApi.FlowCreateItem);
    });
