...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.EventUpdateItem();
  });
  ...
  describe('EventUpdateItem', function() {
    it('should create an instance of EventUpdateItem', function() {
      // uncomment below and update the code to test EventUpdateItem
      //var instane = new ProcessMakerApi.EventUpdateItem();
      //expect(instance).to.be.a(ProcessMakerApi.EventUpdateItem);
    });
