...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.DataModel();
  });
  ...
  describe('DataModel', function() {
    it('should create an instance of DataModel', function() {
      // uncomment below and update the code to test DataModel
      //var instane = new ProcessMakerApi.DataModel();
      //expect(instance).to.be.a(ProcessMakerApi.DataModel);
    });
