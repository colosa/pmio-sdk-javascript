...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.GroupUpdateItem();
  });
  ...
  describe('GroupUpdateItem', function() {
    it('should create an instance of GroupUpdateItem', function() {
      // uncomment below and update the code to test GroupUpdateItem
      //var instane = new ProcessMakerApi.GroupUpdateItem();
      //expect(instance).to.be.a(ProcessMakerApi.GroupUpdateItem);
    });
