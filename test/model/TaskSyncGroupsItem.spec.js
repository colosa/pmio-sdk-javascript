...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.TaskSyncGroupsItem();
  });
  ...
  describe('TaskSyncGroupsItem', function() {
    it('should create an instance of TaskSyncGroupsItem', function() {
      // uncomment below and update the code to test TaskSyncGroupsItem
      //var instane = new ProcessMakerApi.TaskSyncGroupsItem();
      //expect(instance).to.be.a(ProcessMakerApi.TaskSyncGroupsItem);
    });
