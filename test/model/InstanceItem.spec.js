...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InstanceItem();
  });
  ...
  describe('InstanceItem', function() {
    it('should create an instance of InstanceItem', function() {
      // uncomment below and update the code to test InstanceItem
      //var instane = new ProcessMakerApi.InstanceItem();
      //expect(instance).to.be.a(ProcessMakerApi.InstanceItem);
    });
