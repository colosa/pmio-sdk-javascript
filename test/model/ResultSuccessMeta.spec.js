...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.ResultSuccessMeta();
  });
  ...
  describe('ResultSuccessMeta', function() {
    it('should create an instance of ResultSuccessMeta', function() {
      // uncomment below and update the code to test ResultSuccessMeta
      //var instane = new ProcessMakerApi.ResultSuccessMeta();
      //expect(instance).to.be.a(ProcessMakerApi.ResultSuccessMeta);
    });
