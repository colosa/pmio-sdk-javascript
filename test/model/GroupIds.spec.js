...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.GroupIds();
  });
  ...
  describe('GroupIds', function() {
    it('should create an instance of GroupIds', function() {
      // uncomment below and update the code to test GroupIds
      //var instane = new ProcessMakerApi.GroupIds();
      //expect(instance).to.be.a(ProcessMakerApi.GroupIds);
    });
