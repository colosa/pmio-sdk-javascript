...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.TaskAddGroupsItem();
  });
  ...
  describe('TaskAddGroupsItem', function() {
    it('should create an instance of TaskAddGroupsItem', function() {
      // uncomment below and update the code to test TaskAddGroupsItem
      //var instane = new ProcessMakerApi.TaskAddGroupsItem();
      //expect(instance).to.be.a(ProcessMakerApi.TaskAddGroupsItem);
    });
