...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InstanceCollection();
  });
  ...
  describe('InstanceCollection', function() {
    it('should create an instance of InstanceCollection', function() {
      // uncomment below and update the code to test InstanceCollection
      //var instane = new ProcessMakerApi.InstanceCollection();
      //expect(instance).to.be.a(ProcessMakerApi.InstanceCollection);
    });
