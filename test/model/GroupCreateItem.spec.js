...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.GroupCreateItem();
  });
  ...
  describe('GroupCreateItem', function() {
    it('should create an instance of GroupCreateItem', function() {
      // uncomment below and update the code to test GroupCreateItem
      //var instane = new ProcessMakerApi.GroupCreateItem();
      //expect(instance).to.be.a(ProcessMakerApi.GroupCreateItem);
    });
