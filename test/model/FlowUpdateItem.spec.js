...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.FlowUpdateItem();
  });
  ...
  describe('FlowUpdateItem', function() {
    it('should create an instance of FlowUpdateItem', function() {
      // uncomment below and update the code to test FlowUpdateItem
      //var instane = new ProcessMakerApi.FlowUpdateItem();
      //expect(instance).to.be.a(ProcessMakerApi.FlowUpdateItem);
    });
