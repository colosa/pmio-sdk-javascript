...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.UserCreateItem();
  });
  ...
  describe('UserCreateItem', function() {
    it('should create an instance of UserCreateItem', function() {
      // uncomment below and update the code to test UserCreateItem
      //var instane = new ProcessMakerApi.UserCreateItem();
      //expect(instance).to.be.a(ProcessMakerApi.UserCreateItem);
    });
