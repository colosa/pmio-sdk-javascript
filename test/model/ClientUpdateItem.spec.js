...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.ClientUpdateItem();
  });
  ...
  describe('ClientUpdateItem', function() {
    it('should create an instance of ClientUpdateItem', function() {
      // uncomment below and update the code to test ClientUpdateItem
      //var instane = new ProcessMakerApi.ClientUpdateItem();
      //expect(instance).to.be.a(ProcessMakerApi.ClientUpdateItem);
    });
