...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.FlowItem();
  });
  ...
  describe('FlowItem', function() {
    it('should create an instance of FlowItem', function() {
      // uncomment below and update the code to test FlowItem
      //var instane = new ProcessMakerApi.FlowItem();
      //expect(instance).to.be.a(ProcessMakerApi.FlowItem);
    });
