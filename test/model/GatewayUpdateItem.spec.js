...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.GatewayUpdateItem();
  });
  ...
  describe('GatewayUpdateItem', function() {
    it('should create an instance of GatewayUpdateItem', function() {
      ...
      //var instane = new ProcessMakerApi.GatewayUpdateItem();
      //expect(instance).to.be.a(ProcessMakerApi.GatewayUpdateItem);
    });
