...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.EventCreateItem();
  });
  ...
  describe('EventCreateItem', function() {
    it('should create an instance of EventCreateItem', function() {
      // uncomment below and update the code to test EventCreateItem
      //var instane = new ProcessMakerApi.EventCreateItem();
      //expect(instance).to.be.a(ProcessMakerApi.EventCreateItem);
    });
