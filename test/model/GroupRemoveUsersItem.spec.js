...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.GroupRemoveUsersItem();
  });
  ...
  describe('GroupRemoveUsersItem', function() {
    it('should create an instance of GroupRemoveUsersItem', function() {
      // uncomment below and update the code to test GroupRemoveUsersItem
      //var instane = new ProcessMakerApi.GroupRemoveUsersItem();
      //expect(instance).to.be.a(ProcessMakerApi.GroupRemoveUsersItem);
    });
