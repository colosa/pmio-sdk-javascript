...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.GatewayCollection();
  });
  ...
  describe('GatewayCollection', function() {
    it('should create an instance of GatewayCollection', function() {
      // uncomment below and update the code to test GatewayCollection
      //var instane = new ProcessMakerApi.GatewayCollection();
      //expect(instance).to.be.a(ProcessMakerApi.GatewayCollection);
    });
