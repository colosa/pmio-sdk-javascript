...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.GroupSyncUsersItem();
  });
  ...
  describe('GroupSyncUsersItem', function() {
    it('should create an instance of GroupSyncUsersItem', function() {
      // uncomment below and update the code to test GroupSyncUsersItem
      //var instane = new ProcessMakerApi.GroupSyncUsersItem();
      //expect(instance).to.be.a(ProcessMakerApi.GroupSyncUsersItem);
    });
