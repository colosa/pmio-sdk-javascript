...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InstanceAttributes();
  });
  ...
  describe('InstanceAttributes', function() {
    it('should create an instance of InstanceAttributes', function() {
      // uncomment below and update the code to test InstanceAttributes
      //var instane = new ProcessMakerApi.InstanceAttributes();
      //expect(instance).to.be.a(ProcessMakerApi.InstanceAttributes);
    });
    ...
    it('should have the property parentInstanceId (base name: "parent_instance_id")', function() {
      // uncomment below and update the code to test the property parentInstanceId
      //var instane = new ProcessMakerApi.InstanceAttributes();
      //expect(instance).to.be();
    });

    it('should have the property initUserId (base name: "init_user_id")', function() {
      // uncomment below and update the code to test the property initUserId
      //var instane = new ProcessMakerApi.InstanceAttributes();
      //expect(instance).to.be();
    });
