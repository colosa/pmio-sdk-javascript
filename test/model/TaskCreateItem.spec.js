...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.TaskCreateItem();
  });
  ...
  describe('TaskCreateItem', function() {
    it('should create an instance of TaskCreateItem', function() {
      // uncomment below and update the code to test TaskCreateItem
      //var instane = new ProcessMakerApi.TaskCreateItem();
      //expect(instance).to.be.a(ProcessMakerApi.TaskCreateItem);
    });
