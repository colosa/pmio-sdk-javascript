...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.InputOutputCollection();
  });
  ...
  describe('InputOutputCollection', function() {
    it('should create an instance of InputOutputCollection', function() {
      // uncomment below and update the code to test InputOutputCollection
      //var instane = new ProcessMakerApi.InputOutputCollection();
      //expect(instance).to.be.a(ProcessMakerApi.InputOutputCollection);
    });
