...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.BpmnFile();
  });
  ...
  describe('BpmnFile', function() {
    it('should create an instance of BpmnFile', function() {
      // uncomment below and update the code to test BpmnFile
      //var instane = new ProcessMakerApi.BpmnFile();
      //expect(instance).to.be.a(ProcessMakerApi.BpmnFile);
    });
