...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.GroupAttributes();
  });
  ...
  describe('GroupAttributes', function() {
    it('should create an instance of GroupAttributes', function() {
      // uncomment below and update the code to test GroupAttributes
      //var instane = new ProcessMakerApi.GroupAttributes();
      //expect(instance).to.be.a(ProcessMakerApi.GroupAttributes);
    });
