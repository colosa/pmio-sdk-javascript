...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.ErrorArray();
  });
  ...
  describe('ErrorArray', function() {
    it('should create an instance of ErrorArray', function() {
      // uncomment below and update the code to test ErrorArray
      //var instane = new ProcessMakerApi.ErrorArray();
      //expect(instance).to.be.a(ProcessMakerApi.ErrorArray);
    });
