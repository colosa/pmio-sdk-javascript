...
var groupRemoveUsersItem = new ProcessMakerApi.GroupRemoveUsersItem(); // GroupRemoveUsersItem | JSON API response with Users IDs to remove
...
var taskSyncGroupsItem = new ProcessMakerApi.TaskSyncGroupsItem(); // TaskSyncGroupsItem | JSON API response with groups IDs to sync
...
var groupSyncUsersItem = new ProcessMakerApi.GroupSyncUsersItem(); // GroupSyncUsersItem | JSON API with array of users IDs to sync
...
var clientUpdateItem = new ProcessMakerApi.ClientUpdateItem(); // ClientUpdateItem | Client object to edit
...
var eventUpdateItem = new ProcessMakerApi.EventUpdateItem(); // EventUpdateItem | Event object to edit
...
var eventConnectorUpdateItem = new ProcessMakerApi.EventConnectorUpdateItem(); // EventConnectorUpdateItem | EventConnector object to edit
...
var flowUpdateItem = new ProcessMakerApi.FlowUpdateItem(); // FlowUpdateItem | Flow object to edit
...
var gatewayUpdateItem = new ProcessMakerApi.GatewayUpdateItem(); // GatewayUpdateItem | Gateway object to edit
...
var groupUpdateItem = new ProcessMakerApi.GroupUpdateItem(); // GroupUpdateItem | Group object to edit
...
var inputOutputUpdateItem = new ProcessMakerApi.InputOutputUpdateItem(); // InputOutputUpdateItem | Input/Output object to edit
...
var instanceUpdateItem = new ProcessMakerApi.InstanceUpdateItem(); // InstanceUpdateItem | Instance object to edit
...
var processUpdateItem = new ProcessMakerApi.ProcessUpdateItem(); // ProcessUpdateItem | Process object to edit
...
var taskUpdateItem = new ProcessMakerApi.TaskUpdateItem(); // TaskUpdateItem | Task object to edit
...
var taskConnectorUpdateItem = new ProcessMakerApi.TaskConnectorUpdateItem(); // TaskConnectorUpdateItem | TaskConnector object to edit
...
var taskInstanceUpdateItem = new ProcessMakerApi.TaskInstanceUpdateItem(); // TaskInstanceUpdateItem | Task Instance object to update
...
var userUpdateItem = new ProcessMakerApi.UserUpdateItem(); // UserUpdateItem | User object for update
